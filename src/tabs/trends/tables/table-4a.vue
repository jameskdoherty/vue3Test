<template>
    <div class="table-classic__container" id="tableM4a">
        <div class="table-control d-flex justify-center">
            ...
            <input type="radio" id="m4atbl-all-educations-systems" class="all-education-systems" name="m4a-toggle-one"
                checked="checked">
            <label for="m4atbl-all-educations-systems">
                All education systems
            </label>
            <input type="radio" id="m4atbl-oecd-only" class="oecd-only" name="m4a-toggle-one">
...
export default {
    ...
    created() {
        ...
        this.subscription = DataService.getTable4AData().subscribe(
            allResults => {
                //console.log('---table 4A allresults', allResults)
                ...
                //console.log('TABLE 4A finaldata', finalData)
                ...
                class PisaTable {
                    constructor(tableSelector) {
                        ...
                        //console.log('rowhtml',this.rowHtmlTemplate4A)
                    }
                    ...
                    addRow(dataRow) {
                        ...
                        this.wrapper.innerHTML = this.rowHtmlTemplate4A.innerHTML;
                        //console.log('add row wrapper innerhtml', this.wrapper.innerHTML)
                        this.tBody4A.append(this.wrapper);
                        var lastRow = this.tBody4A.lastChild;
                    ...
                    clearTable() {
                        ...
                        document.querySelectorAll('#tbody4A > tr').forEach((el) => {
                    ...
                    updateFigures() {
                       ...
                       // console.log('updatefigu', data)
                        for (var i = 0; i < this.figures.length; i++) {
                           ...
                           // console.log('4a remove these figures', this.figures[i].selector)
                ...
                figureControls['table4a'] = new FigureControl(finalData, mapFunction, [new PisaTable('figure.table-4a table.tbl4a')]);
