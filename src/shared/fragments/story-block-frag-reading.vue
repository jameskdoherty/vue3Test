<template>
  <p>Reading literacy was a <span class="tooltip-container">minor domain <span class="tooltip-text bottom">As a
  ...
  <p>Reading involves not only the printed page but also digital formats. Increasingly, it requires readers to distinguish
    ...
    <blockquote>In PISA 2022 reading literacy is defined as students' capacity to understand, use, evaluate, reflect on, and engage with texts in order to achieve one's goals; develop one's knowledge and potential; and participate in society.</blockquote>
</template>
<script>


export default {
  name: 'story-block-frag-reading',
}
</script>
