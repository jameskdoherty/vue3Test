...
.main-content .secondary-nav li:last-of-type {
    margin-right: 0;
}
...
.main-content .secondary-nav li a.router-link-active:hover {
    cursor: default;
    opacity: 1;
    transition: none;
}
